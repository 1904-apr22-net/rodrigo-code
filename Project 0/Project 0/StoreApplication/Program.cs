    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            Console.WriteLine("What do you want to do?"
                ...
                +"5. Display order history of a store location" //remember to sort
                +"6. Display order history of a customer" //remember to sort
            ...
            if(Input == 1)
            {
                Console.WriteLine("Write name of customer to order for");
